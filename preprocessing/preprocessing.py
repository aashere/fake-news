...
def extract_text_data(api_keys, threshold):
    # Load tweet ids
    fake_tweet_ids = []
    real_tweet_ids = []
    ...
    fake_text_data = __fetch_text_data(fake_tweet_ids, domain, headers, threshold)
    real_text_data = __fetch_text_data(real_tweet_ids, domain, headers, threshold)
...
def __fetch_text_data(tweet_ids, domain, headers, threshold):
    text_data = []
